...
async function loadQuestions(){
  try{
    ...
    // Fallback minimal propre (sans tags)
    QUESTIONS = [{
      prompt:"Exemple : vous avez un travail à rendre ce soir — quelle est votre première action ?",
      weight:1,
      options:[
        {label:"Je clarifie la consigne et j’avance dans l’ordre logique.",profil:"Garant"},
        {label:"Je m’engage sur un résultat rapide et je le livre.",profil:"Conquérant"},
        {label:"Je crée un climat calme et je démarre en douceur.",profil:"Bienveillant"},
        {label:"Je confirme un engagement réaliste et je le respecte.",profil:"Fiable"},
        {label:"Je définis l’idée clé puis j’écris la première action.",profil:"Visionnaire"},
        {label:"Je lance un sprint de dix minutes pour me lancer.",profil:"Spontané"}
      ]
    }];
  }
